...
LOGFILE="/home/lxkj/duck_runtime.log"
exec >> "$LOGFILE" 2>&1
...
# 设置音量为 100%，使用 Master 通道
amixer set Master 100.0%

# Activate the virtualenv (make sure 'workon' is available in non-interactive shell)
source /home/lxkj/.virtualenvs/open-duck-mini-runtime/bin/activate

# Wait for 3 seconds
sleep 3

# Run your command
python -u /home/lxkj/Open_Duck_Mini_Runtime/scripts/py-xiaozhi.py
