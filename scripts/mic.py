...
KEYWORD_PATHS = [
    ...
    '/home/lxkj/Open_Duck_Mini_Runtime/mic/HeyLingxi.ppn'  # 灵犀没事了
]
KEYWORDS = ['唤醒', '前进', '后退', '停止', '左转', '右转', '灵犀没事了']

PORCUPINE_ACCESS_KEY = '9IUhgXqkBiYD+mJ7BGZgxklOQmOMf/Qm9tjK+5jAHO7ofNNKMJ21oQ=='  # 替换成你自己的Key
MOEDL_PATHS = '/home/lxkj/Open_Duck_Mini_Runtime/mic/porcupine_params_zh.pv'
