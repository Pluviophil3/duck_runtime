...
class Imu:
    def __init__(
        ...
        if self.calibrate:
            ...
            # 修改保存路径
            pickle.dump(imu_calib_data, open("/home/lxkj/Open_Duck_Mini_Runtime/imu_calib_data.pkl", "wb"))

            print("Saved", "/home/lxkj/Open_Duck_Mini_Runtime/imu_calib_data.pkl")
            exit()

        # 修改加载路径
        calib_file_path = "/home/lxkj/Open_Duck_Mini_Runtime/imu_calib_data.pkl"
        if os.path.exists(calib_file_path):
            imu_calib_data = pickle.load(open(calib_file_path, "rb"))
            ...
            print(f"{calib_file_path} not found")
